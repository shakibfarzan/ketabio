...
const MultipleSelector = ({
  ...
  return (
    <Command
      ...
      className={cn('h-auto overflow-visible p-0 bg-transparent', commandProps?.className)}
      shouldFilter={
    ...
    >
      <div
        className={cn(
          'border-input shadow-xs focus-within:border-ring focus-within:ring-ring/50 has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive relative h-9.25 rounded-md border text-sm transition-[color,box-shadow] outline-none focus-within:ring-[3px] has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50',
          {
      ...
      >
        <div className="flex flex-wrap gap-1">
          {maxSelected > 1 ? (
            ...
            <div
              className={cn('w-full mt-1 ml-1.5', {
                hidden: maxSelected > 1 || !selected?.[0]?.label,
              })}
            >
              {selected?.[0]?.label}
            </div>
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              'placeholder:text-muted-foreground flex-1 bg-transparent outline-hidden disabled:cursor-not-allowed',
              {
                ...
                hidden: maxSelected === 1 && selected.length !== 0,
              },
